...
const std::map<std::string, common_speculative_type> common_speculative_type_from_name_map = {
    ...
    // mtp: backwards-compat alias for draft-mtp (renamed in upstream PR #22964).
...
common_speculative * common_speculative_init(common_params_speculative & params, uint32_t n_seq) {
    ...
    std::vector<common_speculative_config> configs = {}; // list of speculative configs to try
    {
        ...
        // COUNT == 10 in this build: upstream's 9 (NONE/DRAFT_SIMPLE/DRAFT_EAGLE3/DRAFT_MTP/NGRAM_*)
        // plus DFLASH (elizaOS alias for the draft-model path; dispatches through has_draft_simple).
        ...
        if (has_draft_simple) {
            // DFLASH is the elizaOS alias for the standalone draft-model path.
