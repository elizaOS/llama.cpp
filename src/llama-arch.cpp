...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_KOKORO,           "kokoro"           }, // Kokoro-82M TTS GGUF discriminator; generic model loading rejects it
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_TOKENIZER_MAX_INPUT_CHARS_PER_WORD, "tokenizer.ggml.max_input_chars_per_word" },
