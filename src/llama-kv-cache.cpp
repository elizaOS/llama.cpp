...
bool llama_kv_cache::try_resize() {
    ...
    llama_kv_cache tmp(model, model.hparams, saved_type_k, saved_type_v, saved_v_trans, saved_offload, saved_unified, new_size,
                       saved_n_seq_max, saved_n_pad, saved_n_swa, saved_swa_type, /*mem_other=*/nullptr,
                       saved_filter, saved_reuse, /*share=*/nullptr,
                       /*kv_size_max=*/0);
