...
GGML_API void quantize_row_tbq3_k_ref(const float * GGML_RESTRICT x, block_tbq3_k * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_tbq4_k_ref(const float * GGML_RESTRICT x, block_tbq4_k * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_tbq3_k(const block_tbq3_k * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_tbq4_k(const block_tbq4_k * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_tbq3_k(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_tbq4_k(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
