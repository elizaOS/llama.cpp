...
import {
  compile
} from "./chunk-SOR3F7GI.js";
import "./chunk-2SCGLXP5.js";
import "./chunk-4WYSRR6Q.js";
import {
  __commonJS,
  __toESM
} from "./chunk-G6W4HXRC.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-QMVSHJMP.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-B457SAPO.js")).default;
  return {
