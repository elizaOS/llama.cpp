import CJS_COMPAT_NODE_URL_t17piavj1z from 'node:url';
import CJS_COMPAT_NODE_PATH_t17piavj1z from 'node:path';
import CJS_COMPAT_NODE_MODULE_t17piavj1z from "node:module";

var __filename = CJS_COMPAT_NODE_URL_t17piavj1z.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_t17piavj1z.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_t17piavj1z.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-G6W4HXRC.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-QMVSHJMP.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-B457SAPO.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-P3ASKRBX.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
