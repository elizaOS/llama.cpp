...
class MODEL_TENSOR(IntEnum):
    ...
    NEXTN_PROJ_PRE       = auto() # gemma4-assistant
    NEXTN_PROJ_POST      = auto() # gemma4-assistant
    # lfm2 audio
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    # gemma4-assistant MTP drafter (single projection pair per model, no {bid})
...
class LlamaFileType(IntEnum):
    ...
    MOSTLY_Q1_0_g32      = 100  # except 1d tensors
    MOSTLY_Q1_0_g128     = 101  # except 1d tensors
    MOSTLY_Q4_POLAR      = 102  # except 1d tensors
...
GGML_QUANT_SIZES: dict[GGMLQuantizationType, tuple[int, int]] = {
    ...
    GGMLQuantizationType.Q1_0:      (128, 2 + 16),   # upstream: 128-token group
    # milady custom quant type sizes
    GGMLQuantizationType.Q1_0_g32:  (32, 2 + 4),     # 2 bytes fp16 scale + 4 bytes (32 bits)
